...
import { User, Lock, Loader2, AlertCircle, CheckCircle, X, Save, RefreshCw, Eye, EyeOff } from 'lucide-react';
...
const OwnerSettings = () => {
  ...
  // Get user from Redux (not loading)
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 p-6">
      ...
      <div className="bg-white dark:bg-stone-900 p-8 rounded-xl border border-stone-200 dark:border-stone-800 shadow-sm">
        ...
        {/* Tab Navigation */}
        <div className="border-b border-stone-200 dark:border-stone-800 mb-8">
         <div className="flex overflow-x-scroll space-x-1 no-scrollbar scrollbar-hide">
            {tabs.map((tab) => (
              <button
                key={tab.id}
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative group">
                <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-orange-100 dark:border-orange-900/30 bg-stone-100 shadow-sm transition-transform hover:scale-105">
                  <img 
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="col-span-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-stone-300 dark:border-stone-700 rounded-lg bg-stone-50 dark:bg-stone-800 text-stone-900 dark:text-stone-100 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all"
                />
              </div>
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <input
                  ...
                  disabled
                  className="w-full px-4 py-2.5 border border-stone-300 dark:border-stone-700 rounded-lg bg-stone-100 dark:bg-stone-900 text-stone-500 dark:text-stone-500 cursor-not-allowed"
                />
                <p className="mt-1 text-xs text-stone-400">Email cannot be changed directly.</p>
              </div>
            ...
            <div className="max-w-md space-y-5">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="flex items-center px-6 py-2.5 bg-stone-900 dark:bg-stone-100 hover:bg-stone-800 dark:hover:bg-stone-200 text-white dark:text-stone-900 rounded-lg font-medium transition-all shadow-sm disabled:opacity-70 disabled:cursor-not-allowed min-w-[170px] justify-center"
                >
                  {passwordLoading ? (
                    <>
                      <Loader2 size={18} className="animate-spin mr-2" />
